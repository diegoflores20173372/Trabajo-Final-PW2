...
public class ProductosControllerAdd extends HttpServlet {
	...
	public void doPost(HttpServletRequest requ, HttpServletResponse respon) throws IOException, ServletException {
		...
		try{
			...
			if(cont==0){	
				Producto  prod= new Producto(requ.getParameter("modelo"), requ.getParameter("marca"),requ.getParameter("medida"),requ.getParameter("precio"),requ.getParameter("aro"),true);
